...
This file is read automatically by every Claude Code agent in this project. It is the source of standing rules. The full design is in `docs/shared-core-spec.md` — read it before building.
...
These approvals can be granted from the Claude mobile app. When in doubt, propose the action and stop.
